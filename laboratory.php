...
<html lang="en">
  ...
  <body>
    ...
    <main class="mt-5 pt-3">
      <div class="container-fluidlab">
        <div class="row mx 5">
          <div class="col-md-12">
            <h4><p class="text-center">LABORATORIO DE AUTOMATIZACIÓN</p></h4>
          </div>
        </div>
        ...
        <div class="row mx-5">
            <div class="col ml-5">
                            <div class="card" style="width: 20rem;">
                                <img class="card-img-top" src="images/laboratory1.png" alt="Card image cap">
                                <div class="card-body">
            ...
            <div class="col ml-5">
                            <div class="card" style="width: 20rem;">
                                <img class="card-img-top" src="images/laboratory2.png" alt="Card image cap">
                                <div class="card-body">
            ...
            <div class="col ml-5">
                            <div class="card" style="width: 20rem;">
                                <img class="card-img-top" src="images/laboratory3.png" alt="Card image cap">
                                <div class="card-body">
