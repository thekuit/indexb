  ...
  <body>
    ...
    <main class="mt-5 pt-3">
      <div class="container-fluiddoc">
        ...
        <form>
            <div class="mb-3">
                <label for="namestudent" class="form-label">Nombre completo</label>
                <input type="text" class="form-control" id="namestudent" aria-describedby="nameHelp">
                </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                <label for="exampleInputci" class="form-label">Cedula de identidad</label>
                <input type="number" class="form-control" id="exampleInputci" aria-describedby="ciHelp">
                </div>
            <div class="mb-3">
